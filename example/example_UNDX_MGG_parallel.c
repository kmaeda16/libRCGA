/*
Parallel version of UNDX/MGG with stochastic ranking.
...
Parallelization is useful when evaluation of f and g's takes long computational time.
*/
...
int main(int argc, char **argv)
{
	...
	out_transition = "UNDX_MGG_parallel_transition.dat"; // File name of the output file which shows the best individual during the search. This file is produced every output_intvl generations. If output_intvl < 1, this output file is not produced.
	out_solution   = "UNDX_MGG_parallel_solution.dat";   // File name of the output file which shows the best individual during the search. This file is produced at the end of the search.
	out_population = "UNDX_MGG_parallel_population.dat"; // File name of the output file which shows the population at the final generation. This file is produced at the end of the search.
	...
	RCGAInitial(&argc,&argv,seed,n_gene,n_generation,n_population,
		n_children,allowable_error,t_limit,
