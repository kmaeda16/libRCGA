/*
Serial version of REXstar/JGG with stochastic ranking.
...
int main(int argc, char **argv)
{
	...
	out_transition = "REXstar_JGG_serial_transition.dat"; // File name of the output file which shows the best individual during the search. This file is produced every output_intvl generations. If output_intvl < 1, this output file is not produced.
	out_solution   = "REXstar_JGG_serial_solution.dat";   // File name of the output file which shows the best individual during the search. This file is produced at the end of the search.
	out_population = "REXstar_JGG_serial_population.dat"; // File name of the output file which shows the population at the final generation. This file is produced at the end of the search.
